...
const bn = {
  ...
  'chelp.e5.a': 'আপনি খাতায় (ধার), অনলাইনে, বা নগদে দিতে পারেন। খাতায় নিলে সেই টাকা ওই দোকানে আপনার চলতি ব্যালেন্সে জমা হয়, পরে মেটাতে পারেন।',
  'chelp.e6.q': 'আমার খাতা (ধার) কীভাবে চলে?',
  'chelp.e6.a': 'আপনার খাতা প্রতিটি দোকানে আপনার বাকি এক জায়গায় দেখায়। প্রতিটি কেনা আর পরিশোধ লেখা থাকে, তাই আপনার ব্যালেন্স সবসময় জানা থাকে আর বিবরণ দেখতে বা ডাউনলোড করতে পারেন।',
...
const gu = {
  ...
  'txn.upi': 'UPI ચૂકવણી',
  'txn.adjustment': 'દુકાન તરફથી સમાયોજન',
  ...
  'stmt.totalAdjusted': 'દુકાન તરફથી સમાયોજન',
  ...
  'chelp.e5.a': 'તમે ખાતામાં (ઉધાર), ઓનલાઇન, કે રોકડ ચૂકવી શકો છો. ખાતામાં લો તો એ રકમ એ દુકાનમાં તમારા ચાલુ બેલેન્સમાં ઉમેરાય છે, પછી ચૂકવી શકાય.',
...
const ur = {
  ...
  'coedit.reduced': '{item} — {before} → {after}',
  'coedit.nowTotal': 'آپ کے آرڈر کا کل اب {now} ہے۔',
