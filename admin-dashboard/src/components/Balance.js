...
import { moneyAbs } from '../lib/money';

// Shared, meaning-colored balance renderer for the low-literacy owner audience.
// It shows the EXACT ₹ figure (the shared lib/money.js helper, so the grouping
// is Indian here as everywhere) and ADDS a color + a one-word in-language label so the
